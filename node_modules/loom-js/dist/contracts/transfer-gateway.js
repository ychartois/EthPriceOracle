...
var TransferGateway = /** @class */ (function (_super) {
    ...
    function TransferGateway(params) {
        ...
        _this.on(contract_1.Contract.EVENT, function (event) {
            ...
            if (event.topics[0] === TransferGateway.tokenWithdrawalSignedEventTopic) {
                var eventData = transfer_gateway_pb_1.TransferGatewayTokenWithdrawalSigned.deserializeBinary((0, crypto_utils_1.B64ToUint8Array)(event.data));
                var tokenId = void 0;
                ...
                switch (tokenKind) {
                    case transfer_gateway_pb_1.TransferGatewayTokenKind.ERC721:
                        tokenId = (0, big_uint_1.unmarshalBigUIntPB)(eventData.getTokenId());
                        value = tokenId;
                        break;
                    ...
                    default:
                        tokenAmount = (0, big_uint_1.unmarshalBigUIntPB)(eventData.getTokenAmount());
                        value = tokenAmount;
                        break;
                }
                ...
                var contractMappingConfirmed = transfer_gateway_pb_1.TransferGatewayContractMappingConfirmed.deserializeBinary((0, crypto_utils_1.B64ToUint8Array)(event.data));
    ...
    TransferGateway.prototype.withdrawERC721Async = function (tokenId, tokenContract, recipient) {
        ...
        req.setTokenId((0, big_uint_1.marshalBigUIntPB)(tokenId));
    ...
    TransferGateway.prototype.withdrawERC721XAsync = function (tokenId, amount, tokenContract, recipient) {
        ...
        req.setTokenId((0, big_uint_1.marshalBigUIntPB)(tokenId));
        req.setTokenAmount((0, big_uint_1.marshalBigUIntPB)(amount));
        req.setTokenContract(tokenContract.MarshalPB());
        if (recipient) {
            req.setRecipient(recipient.MarshalPB());
        }
                        ...
                        for (_i = 0, unclaimedTokens_1 = unclaimedTokens; _i < unclaimedTokens_1.length; _i++) {
                            ...
                            if (tokenKind === transfer_gateway_pb_1.TransferGatewayTokenKind.ERC721) {
                                ...
                                for (_a = 0, _b = token.getAmountsList(); _a < _b.length; _a++) {
                                    amt = _b[_a];
                                    tokenIds.push((0, big_uint_1.unmarshalBigUIntPB)(amt.getTokenId()));
                                }
                            }
                                ...
                                for (_c = 0, _d = token.getAmountsList(); _c < _d.length; _c++) {
                                    amt = _d[_c];
                                    tokenIds.push((0, big_uint_1.unmarshalBigUIntPB)(amt.getTokenId()));
                                    tokenAmounts.push((0, big_uint_1.unmarshalBigUIntPB)(amt.getTokenAmount()));
                                }
                            }
                            else {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                ...
                                totalWithdrawalAmount: amount ? (0, big_uint_1.unmarshalBigUIntPB)(amount) : new bn_js_1.default(0),
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                maxTotalDailyWithdrawalAmount: maxTotalDailyWithdrawalAmount
                                    ? (0, big_uint_1.unmarshalBigUIntPB)(maxTotalDailyWithdrawalAmount)
                                    : new bn_js_1.default(0),
                                maxPerAccountDailyWithdrawalAmount: maxPerAccountDailyWithdrawalAmount
                                    ? (0, big_uint_1.unmarshalBigUIntPB)(maxPerAccountDailyWithdrawalAmount)
                                    : new bn_js_1.default(0),
                                lastWithdrawalLimitResetTime: lastWithdrawalLimitResetTime
                                    ? new Date(lastWithdrawalLimitResetTime * 1000)
                                    : new Date(0),
                                totalWithdrawalAmount: totalWithdrawalAmount
                                    ? (0, big_uint_1.unmarshalBigUIntPB)(totalWithdrawalAmount)
                                    : new bn_js_1.default(0)
                            }];
                }
            });
...
function unmarshalWithdrawalReceipt(receipt) {
    ...
    switch (tokenKind) {
        case transfer_gateway_pb_1.TransferGatewayTokenKind.ERC721:
            tokenId = (0, big_uint_1.unmarshalBigUIntPB)(receipt.getTokenId());
            value = tokenId;
            break;
        case transfer_gateway_pb_1.TransferGatewayTokenKind.ERC721X:
            tokenId = (0, big_uint_1.unmarshalBigUIntPB)(receipt.getTokenId());
        ...
        // tslint:disable-next-line: no-switch-case-fall-through
        default:
            tokenAmount = (0, big_uint_1.unmarshalBigUIntPB)(receipt.getTokenAmount());
            value = tokenAmount;
            break;
    }
    return {
